...
\newenvironment{table-env}[2][x]{
  \clearpage
  \newgeometry{top=0.5in, bottom=1in, inner=0.75in, outer=0.75in, footskip=0.25in}
  \begin{sidewaystable}
  \fontsize{8pt}{10pt}\selectfont
  \ifnum\pdfstrcmp{#1}{x}=-1
    \rotatebox[origin=c]{270}{\begin{minipage}{\textwidth}\caption{\roboto\selectfont\textcolor{Gray}{\uppercase{#1}}}\label{tbl:#2}\end{minipage}}
  \fi
}
{
  \end{sidewaystable}
