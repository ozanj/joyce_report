...
\usepackage{sectsty}
\sectionfont{\fontfamily{pag}\selectfont\color{LogoTurquoise1}\vspace{-18pt}\Large\uppercase}
\subsectionfont{\color{LogoTurquoise1}\vspace{-18pt}\mdseries\Large}
...
\fancyfoot[LE]{\thepage \hspace{0.4cm} \roboto\selectfont\textcolor{LightRed}{\uppercase{Oh, The Places They'll Go}}}
...
\begin{figure}[!h]
    ...
    \makebox[0.79\paperwidth][c]{\hspace{-3cm}\includegraphics[width=0.2\paperwidth, cfbox=DarkGray 1pt]{images/139959/titled_map}\hfill
