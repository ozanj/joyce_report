...
% Params: (legend), image filename/fig reference, caption, crop, subcaptions, width
\usepackage{stfloats}
...
\fi
    ...
    \begin{subfigure}[b]{#9\linewidth}
      \includegraphics[width=\linewidth, cfbox=Gray 0.4pt, trim={0 #4cm 0 #4cm}, clip]{images/maps/#2_1}
      \caption{#5}
    \end{subfigure}\hfill
    \begin{subfigure}[b]{#9\linewidth}
      \includegraphics[width=\linewidth, cfbox=Gray 0.4pt, trim={0 #4cm 0 #4cm}, clip]{images/maps/#2_2}
      \caption{#6}
    \end{subfigure}
    \ifnum\pdfstrcmp{#1}{x}=-1
      \hspace*{0.4cm}
    ...
    \fi
    \begin{subfigure}[b]{#9\linewidth}
      \includegraphics[width=\linewidth, cfbox=Gray 0.4pt, trim={0 #4cm 0 #4cm}, clip]{images/maps/#2_3}
      \caption{#7}
    \end{subfigure}\hfill
    \begin{subfigure}[b]{#9\linewidth}
      \includegraphics[width=\linewidth, cfbox=Gray 0.4pt, trim={0 #4cm 0 #4cm}, clip]{images/maps/#2_4}
      \caption{#8}
    \end{subfigure}
    \ifnum\pdfstrcmp{#1}{x}=-1
      \hspace*{0.4cm}
    ...
    \ifnum\pdfstrcmp{#1}{x}=-1
      \begin{tikzpicture}[remember picture,overlay]
           \node [outer sep=1cm,above,yshift=1.25in] at (0,0)
