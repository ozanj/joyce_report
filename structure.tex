...
\begin{figure}[!h#9]
    ...
    \includegraphics[width=0.45\textwidth, cfbox=#1 0.4pt, trim={#5cm #6cm #7cm #8cm}, clip]{assets/images/#2}
...
\begin{figure*}[!h#1]
    ...
    \includegraphics[width=0.8\textwidth, cfbox=#5 0.4pt]{assets/images/maps/#2}
    \caption{\roboto\selectfont\textcolor{Gray}{\uppercase{#3}}}
    \label{fig:#4}
...
\fi
    ...
    \begin{subfigure}[b]{#9\linewidth}
      \includegraphics[width=\linewidth, cfbox=Gray 0.4pt]{assets/images/maps/#2_1}
      \caption{#5}
    \end{subfigure}\hfill
    \begin{subfigure}[b]{#9\linewidth}
      \includegraphics[width=\linewidth, cfbox=Gray 0.4pt]{assets/images/maps/#2_2}
      \caption{#6}
    \end{subfigure}
    \ifnum\pdfstrcmp{#1}{x}=-1
      \hspace*{0.4cm}
    ...
    \fi
    \begin{subfigure}[b]{#9\linewidth}
      \includegraphics[width=\linewidth, cfbox=Gray 0.4pt]{assets/images/maps/#2_3}
      \caption{#7}
    \end{subfigure}\hfill
    \begin{subfigure}[b]{#9\linewidth}
      \includegraphics[width=\linewidth, cfbox=Gray 0.4pt]{assets/images/maps/#2_4}
      \caption{#8}
    \end{subfigure}
    \ifnum\pdfstrcmp{#1}{x}=-1
      \hspace*{0.4cm}
    ...
    \ifnum\pdfstrcmp{#1}{x}=-1
      \begin{tikzpicture}[remember picture,overlay]
           \node [outer sep=1cm,above,yshift=#4in] at (0,0)  % 1.25
             {\includegraphics[width=0.25\linewidth, cfbox=Gray 0.4pt]{assets/images/maps/#1}};
      \end{tikzpicture}
    \fi
...
\begin{figure*}[#1]
    ...
    \begin{minipage}[c]{0.47\textwidth}
        \includegraphics[width=\linewidth, cfbox=Gray 0.4pt, trim={1.6in 1.5in 1.5in 2in}, clip]{assets/images/#2}
        \caption{\roboto\selectfont\textcolor{Gray}{\uppercase{#3}}}
        \label{fig:#4}
    \end{minipage}
    \hfill
    \begin{minipage}[c]{0.47\textwidth}
        \includegraphics[width=\linewidth, cfbox=Gray 0.4pt, trim={1.6in 1.5in 1.5in 2in}, clip]{assets/images/#5}
...
\begin{figure*}[t]
    ...
    \includegraphics[width=0.3\textwidth, page=9, cfbox=Gray 0.4pt, trim={#1in 1.5in 1.5in 1.5in}, clip]{assets/graphs/#2}\hfill
    \includegraphics[width=0.3\textwidth, page=2, cfbox=Gray 0.4pt, trim={#1in 1.5in 1.5in 1.5in}, clip]{assets/graphs/#2}\hfill
    \includegraphics[width=0.3\textwidth, page=1, cfbox=Gray 0.4pt, trim={#1in 1.5in 1.5in 1.5in}, clip]{assets/graphs/#2}

    \smallskip

    \includegraphics[width=0.3\textwidth, page=8, cfbox=Gray 0.4pt, trim={#1in 1.5in 1.5in 1.5in}, clip]{assets/graphs/#2}\hfill
    \includegraphics[width=0.3\textwidth, page=14, cfbox=Gray 0.4pt, trim={#1in 1.5in 1.5in 1.5in}, clip]{assets/graphs/#2}\hfill
    \includegraphics[width=0.3\textwidth, page=10, cfbox=Gray 0.4pt, trim={#1in 1.5in 1.5in 1.5in}, clip]{assets/graphs/#2}

    \smallskip

    \includegraphics[width=0.3\textwidth, page=11, cfbox=Gray 0.4pt, trim={#1in 1.5in 1.5in 1.5in}, clip]{assets/graphs/#2}\hfill
    \includegraphics[width=0.3\textwidth, page=4, cfbox=Gray 0.4pt, trim={#1in 1.5in 1.5in 1.5in}, clip]{assets/graphs/#2}\hfill
    \includegraphics[width=0.3\textwidth, page=12, cfbox=Gray 0.4pt, trim={#1in 1.5in 1.5in 1.5in}, clip]{assets/graphs/#2}

    \smallskip

    \includegraphics[width=0.3\textwidth, page=6, cfbox=Gray 0.4pt, trim={#1in 1.5in 1.5in 1.5in}, clip]{assets/graphs/#2}\hfill
    \includegraphics[width=0.3\textwidth, page=13, cfbox=Gray 0.4pt, trim={#1in 1.5in 1.5in 1.5in}, clip]{assets/graphs/#2}\hfill
    \includegraphics[width=0.3\textwidth, page=16, cfbox=Gray 0.4pt, trim={#1in 1.5in 1.5in 1.5in}, clip]{assets/graphs/#2}

    \smallskip

    \includegraphics[width=0.3\textwidth, page=5, cfbox=Gray 0.4pt, trim={#1in 1.5in 1.5in 1.5in}, clip]{assets/graphs/#2}\hfill
    \includegraphics[width=0.3\textwidth, page=3, cfbox=Gray 0.4pt, trim={#1in 1.5in 1.5in 1.5in}, clip]{assets/graphs/#2}\hfill
    \includegraphics[width=0.3\textwidth, page=7, cfbox=Gray 0.4pt, trim={#1in 1.5in 1.5in 1.5in}, clip]{assets/graphs/#2}
...
% Params: line spacing (default: 10pt), filename in the tables/ folder, caption, tbl reference (or `x` if continued table), footnotes, text size (usu 8pt but 6pt for appendix)
\newcommand{\addLandscapeTable}[6][10] {  % Add Landscape Table
\afterpage{
