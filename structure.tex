...
\definecolor{LightBlue}{RGB}{247, 255, 254}
...
\usepackage{sectsty}
\sectionfont{\Avenir\selectfont\color{LogoTurquoise1}\vspace*{-10pt}\Large\uppercase}
\subsectionfont{\Avenir\selectfont\color{LogoTurquoise1}\vspace*{-10pt}\mdseries\Large}
