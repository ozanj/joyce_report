...
\usepackage{sectsty}
\sectionfont{\Avenir\selectfont\color{LogoTurquoise1}\vspace{-18pt}\Large\uppercase}
\subsectionfont{\Avenir\selectfont\color{LogoTurquoise1}\vspace{-18pt}\mdseries\Large}
